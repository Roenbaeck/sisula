...
public partial class Try_Execute {
    [
        Microsoft.SqlServer.Server.SqlFunction (
            SystemDataAccess  = SystemDataAccessKind.None,
    ...
    public static SqlString InitMethod(SqlString statement) {
    ...
    private static readonly SqlConnection databaseConnection = new SqlConnection("context connection=true");
    private static readonly SqlCommand command = new SqlCommand("", databaseConnection);
}
