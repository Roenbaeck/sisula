...
END
GO
IF Object_ID('OC_Occasion__SMHI_Weather_TemperatureNewMetadata_Typed', 'P') IS NOT NULL
DROP PROCEDURE [OC_Occasion__SMHI_Weather_TemperatureNewMetadata_Typed];
GO
CREATE PROCEDURE [OC_Occasion__SMHI_Weather_TemperatureNewMetadata_Typed] 
AS
BEGIN
    SET NOCOUNT ON;
