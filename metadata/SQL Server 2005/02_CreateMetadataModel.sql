...
CREATE TABLE [metadata].[JB_EST_Job_ExecutionStatus] (
    ...
    JB_EST_ChangedAt datetime not null,
...
CREATE TABLE [metadata].[CO_DSC_Container_Discovered] (
    ...
    CO_DSC_ChangedAt datetime not null,
...
CREATE TABLE [metadata].[OP_INS_Operations_Inserts] (
    ...
    OP_INS_ChangedAt datetime not null,
...
CREATE TABLE [metadata].[OP_UPD_Operations_Updates] (
    ...
    OP_UPD_ChangedAt datetime not null,
...
CREATE TABLE [metadata].[OP_DEL_Operations_Deletes] (
    ...
    OP_DEL_ChangedAt datetime not null,
...
SELECT
    *
FROM
    [metadata].[pCO_Container](getdate());
GO
-- Difference perspective ---------------------------------------------------------------------------------------------
...
SELECT
    *
FROM
    [metadata].[pCF_Configuration](getdate());
GO
-- Difference perspective ---------------------------------------------------------------------------------------------
...
SELECT
    *
FROM
    [metadata].[pOP_Operations](getdate());
GO
-- Difference perspective ---------------------------------------------------------------------------------------------
...
BEGIN
    ...
    DECLARE @inserted TABLE (
        ...
        JB_EST_ChangedAt datetime null,
...
BEGIN
    ...
    DECLARE @inserted TABLE (
        ...
        CO_DSC_ChangedAt datetime null,
...
SELECT
    *
FROM
    [metadata].[pWO_part_JB_of](getdate());
GO
-- Drop perspectives --------------------------------------------------------------------------------------------------
...
SELECT
    *
FROM
    [metadata].[pJB_formed_CF_from](getdate());
GO
-- Drop perspectives --------------------------------------------------------------------------------------------------
...
SELECT
    *
FROM
    [metadata].[pWO_operates_CO_source_CO_target_OP_with](getdate());
GO
-- Drop perspectives --------------------------------------------------------------------------------------------------
...
SELECT
    *
FROM
    [metadata].[pWO_formed_CF_from](getdate());
GO
-- TIE TRIGGERS -------------------------------------------------------------------------------------------------------
--
-- The following triggers on the latest view make it behave like a table.
